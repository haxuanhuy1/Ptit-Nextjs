...
const Contract = () => {
  ...
  const handleClick = () => {
    ...
    return (
      <div className={clsx(Styles.contract)}>
      <animated.div style={slideInAnimation} className={clsx("slide-up-window")}>
...
<button  onClick={()=>{}} type="button" className={clsx("btn btn-secondary", Styles.button2)} data-dismiss="modal">Tiếp tục</button>
</div>
</div>
</form>
